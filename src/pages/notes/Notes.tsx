...
const Notes = () => {
  ...
  const handleChangeNotes = async (e: React.ChangeEvent<HTMLTextAreaElement>) => {
  ...
  const handleDeleteEmptyItem = async (data: { from: number; this: number }) => {
    setIsButDisable(false);
      ...
      <main className="notes-container">
        ...
        {isMobile && toggle && (
          <section className="right-col">
            ...
            <div className="scroll-right" style={{ paddingBottom: "70px", overflowY: "auto" }}>
              {visibleForm()}
            </div>
          </section>
        )}
